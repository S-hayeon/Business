...
def fetch_data():
    ...
    requestResponse = requests.get("https://api.tiingo.com/tiingo/crypto/prices?tickers=btcusd&startDate=2019-01-02&resampleFreq=5min&token=bc908ecf0174940b54fc0841864d52642a607604", headers=headers)
