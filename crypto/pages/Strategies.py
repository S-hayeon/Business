...
if strategy=='VWAP_Bollinger_RSI':
  ...
  sl_co_efficient=st.sidebar.number_input("Stop Loss Co-efficient",min_value=1,step=0.01)
  tp_co_efficient=st.sidebar.number_input("Reward Ratio Co-efficient",min_value=1,step=0.01)
